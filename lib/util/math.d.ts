...
declare const _default: {
    ...
    PathUtil: {
        ...
        intersection: {
            (path1: G.Common.SVGPathOrStr, path2: G.Common.SVGPathOrStr): G.Common.Point[];
            (path1: G.Common.SVGPathOrStr, path2: G.Common.SVGPathOrStr, justCount: true): number;
        };
        pathIntersection: {
            (path1: G.Common.SVGPathOrStr, path2: G.Common.SVGPathOrStr): G.Common.Point[];
            (path1: G.Common.SVGPathOrStr, path2: G.Common.SVGPathOrStr, justCount: true): number;
        ...
        path2absolute: (pathArray: G.Common.SVGPathOrStr) => (["M" | "m", number, number] | ["L" | "l", number, number] | ["H" | "h", number] | ["V" | "v", number] | ["C" | "c", number, number, number, number, number, number] | ["s" | "S", number, number, number, number] | ["q" | "Q", number, number, number, number] | ["T" | "t", number, number] | ["a" | "A", number, number, number, number, number, number, number] | ["Z" | "z"])[];
        ...
        path2curve: (path: G.Common.SVGPathOrStr, path2?: G.Common.SVGPathOrStr) => (["M" | "m", number, number] | ["L" | "l", number, number] | ["H" | "h", number] | ["V" | "v", number] | ["C" | "c", number, number, number, number, number, number] | ["s" | "S", number, number, number, number] | ["q" | "Q", number, number, number, number] | ["T" | "t", number, number] | ["a" | "A", number, number, number, number, number, number, number] | ["Z" | "z"])[];
